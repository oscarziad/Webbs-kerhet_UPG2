...
namespace Webbsäkerhet_UPG2.Controllers
{
    public class ForumFilesController : Controller
    {
        ...
        {
            return View(await Db.File.ToListAsync());
        }
        ...
        public async Task<IActionResult> UploadFile()
        {
            ...
            while (section != null)
            {
                ...
                !string.IsNullOrEmpty(theContentDisposition.FileName.Value))
                {
                    ...
                    await Db.File.AddAsync(forumFile);
        ...
        {
            var forumFile = await Db.File.FindAsync(id);
            Db.File.Remove(forumFile);
            await Db.SaveChangesAsync();
